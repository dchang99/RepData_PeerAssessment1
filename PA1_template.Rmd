...
<br>The missing values all appear in the steps field. The presence of missing values may introduce bias into some calculations or summaries of the data. Previously calculated mean number of steps across all days sampled for the corresponding time interval will be substituted for these missing values.
...
```{r PlotIntervalMeansImpute, fig.height=4, fig.width=10}
